    ...
    async function ajaxSearchPOI() {
        ...
        if (results.length > 0) {
            ...
            results.forEach((poi) => {
                ...
                description.setAttribute("class", "form-control bg-light border-0 small");
                ...
                reviewBtn.setAttribute("class", "d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm");
                ...
                recommendBtn.setAttribute("class", "d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm");
                recommendBtn.addEventListener("click", recommend.bind(this, poi.id));
                form.appendChild(recommendBtn);

                domDiv.appendChild(form);              

                L.marker([poi.lat, poi.lon]).addTo(markerGroup)
                    .bindPopup(domDiv);
